...
The [Frontier Model Forum](https://www.frontiermodelforum.org) is an industry-supported non-profit focused on addressing significant risks to public safety and national security. We have three core mandates: 
...
1. [The Adolescence of Technology, January 2026](https://www.darioamodei.com/essay/the-adolescence-of-technology#humanity-s-test)
...
2. [Machines of Loving Grace1, October 2024](https://www.darioamodei.com/essay/machines-of-loving-grace) - By powerful AI, I have in mind an AI model — likely similar to today’s LLMs in form, though it might be based on a different architecture, might involve several interacting models, and might be trained differently—with the following properties:
...
1. [Yann LeCun Home Page](http://yann.lecun.com)
